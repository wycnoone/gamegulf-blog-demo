...
Game queue entry:
{
  "url": "https://www.gamegulf.com/detail/grUAotLPOzA",
  "status": "in_progress",
  "priority": "normal",
  "added": "2026-05-01",
  "completed": null,
  ...
  "automation": {
    ...
    "startedAt": "2026-05-01T23:21:16.345Z",
    "updatedAt": "2026-05-01T23:21:16.345Z"
  }
}

Inputs:
- Brief: content/briefs/mega-man-x-legacy-collection-2.json
- Expected article slug: mega-man-x-legacy-collection-2-worth-it
- Expected article paths:
  - src/content/posts/en/mega-man-x-legacy-collection-2-worth-it.md
  - src/content/posts/zh-hans/mega-man-x-legacy-collection-2-worth-it.md
  - src/content/posts/ja/mega-man-x-legacy-collection-2-worth-it.md
  - src/content/posts/fr/mega-man-x-legacy-collection-2-worth-it.md
  - src/content/posts/es/mega-man-x-legacy-collection-2-worth-it.md
  - src/content/posts/de/mega-man-x-legacy-collection-2-worth-it.md
  - src/content/posts/pt/mega-man-x-legacy-collection-2-worth-it.md

Required workflow:
1. Run node scripts/validate-article.mjs src/content/posts/en/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/zh-hans/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/ja/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/fr/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/es/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/de/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/pt/mega-man-x-legacy-collection-2-worth-it.md to see current hard errors.
2. If article files are missing, run node scripts/synthesize-worth-it-from-brief.mjs content/briefs/mega-man-x-legacy-collection-2.json and node scripts/sync-article-pricing.mjs src/content/posts/en/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/zh-hans/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/ja/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/fr/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/es/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/de/mega-man-x-legacy-collection-2-worth-it.md src/content/posts/pt/mega-man-x-legacy-collection-2-worth-it.md.
...
Output only a JSON object matching this shape:
{
  ...
  "slug": "mega-man-x-legacy-collection-2-worth-it",
  "score": 0,
  "revisionAttempts": 0,
  "validated": false,
  "articlePaths": ["src/content/posts/en/mega-man-x-legacy-collection-2-worth-it.md","src/content/posts/zh-hans/mega-man-x-legacy-collection-2-worth-it.md","src/content/posts/ja/mega-man-x-legacy-collection-2-worth-it.md","src/content/posts/fr/mega-man-x-legacy-collection-2-worth-it.md","src/content/posts/es/mega-man-x-legacy-collection-2-worth-it.md","src/content/posts/de/mega-man-x-legacy-collection-2-worth-it.md","src/content/posts/pt/mega-man-x-legacy-collection-2-worth-it.md"],
  "issues": ["..."],
  "commandsRun": ["..."],
  "notes": "short summary"
}
