...
playerNeeds:
  ...
  - value_for_money
tags:
  - ori will of the wisps switch
  - ori worth it 2026
  - ori switch performance
  - metroidvania switch
  - ori will of the wisps price
playerVoices:
  - quote: Movement flow feels even better than Blind Forest once upgrades click
    sentiment: positive
  - quote: Boss gauntlets punished me harder than I expected mid-game
    sentiment: negative
  - quote: Spirit Trials gave me a reason to re-run areas without feeling grindy
    sentiment: positive
  - quote: Some save points still feel too far apart for my patience
    sentiment: negative
  - quote: Soundtrack plus art direction justify the purchase emotionally
    sentiment: positive
  - quote: Map can feel huge if you hate retracing for one missed path
    sentiment: mixed
communityMemes:
  - Ori tiny squeak big feelings
  - Grapple go brrr
  - Spirit Trials reset addiction
  - Shame on you owl
