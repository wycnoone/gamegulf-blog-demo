...
playerVoices:
  ...
  - quote: Veja primeiro o preço da sua região.
    sentiment: positive
communityMemes:
  - Hollow Knight promoções vigiadas
...
Antes de pagar, abra a **[grade de preços do GameGulf](https://www.gamegulf.com/detail/6mHaDw6g1U5#currency-price)** para confirmar se a **promoção** vale para a sua região.
...
- Você gosta do ritmo **ação, aventura e plataforma** e a faixa **90 Metacritic** combina com sua expectativa
- Sua região já aparece na faixa de **promoção** destacada pelo **GameGulf** — [confira de novo](https://www.gamegulf.com/detail/6mHaDw6g1U5#currency-price)
- Você quer sessões compatíveis com sua rotina — **~27 h campanha, 42 h extras, ~65 h 100%**
