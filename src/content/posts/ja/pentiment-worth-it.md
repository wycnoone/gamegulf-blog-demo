---
title: 2026年、Nintendo Switchで『Pentiment』は買い？
...
communityMemes:
  ...
  - region hopper
  - MSRP sticker shock
tldr: Pentiment — Metacritic 90点台；价格信号偏买入（口味要对）。
priceRows:
  - regionCode: US
    eurPrice: 8.55
    nativePrice: $19.99
...
faq:
  - question: 2026年、Nintendo Switchで『Pentiment』は買い？
    answer: >-
...
**Pentiment** reads as **Metacritic 90点台**  — **Adventure, Puzzle** beats match what the eShop card promises. **session-friendly runtime** frames how much game you are buying.

**セール**履歴：**最安値**は **€5.64** 付近（JP）、直近1年で **10** 回の動き、**平均セール価格**は **€9.64**、直近の大きめの動きから **22** 日（**2026-03-31 (Japan, €5.64)**，**2026**）。[GameGulfの価格](https://www.gamegulf.com/detail/a4rTYMFl9zT#currency-price)で最新行を確認してください。
...
## 『Pentiment』はNintendo Switchでいまいくら？
...
**Pentiment** is a **Adventure, Puzzle** package from **Obsidian Entertainment** — treat the long store blurb as marketing, but the **genre mix** and **Metacritic 90点台** signal are the real buying compass.
...
## 『Pentiment』(Nintendo Switch)の最後に
