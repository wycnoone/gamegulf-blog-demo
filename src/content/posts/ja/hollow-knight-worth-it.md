...
communityMemes:
  ...
  - region hopper
  - MSRP sticker shock
tldr: Hollow Knight — Metacritic 90点台；价格信号偏买入（口味要对）。
priceRows:
  - regionCode: BR
    eurPrice: 4.69
    nativePrice: R$27.99
...
**Hollow Knight** reads as **Metacritic 90点台**  — **Action, Adventure, Platformer** beats match what the eShop card promises. **session-friendly runtime** frames how much game you are buying.

**セール**履歴：**最安値**は **€4.69** 付近（表参照）、直近1年で **0** 回の動き、**平均セール価格**は **€4.69**、直近の大きめの動きから **—** 日（**2026 tracker window (cheapest indexed row €4.69)**，**2026**）。[GameGulfの価格](https://www.gamegulf.com/detail/6mHaDw6g1U5#currency-price)で最新行を確認してください。
...
**Hollow Knight** is a **Action, Adventure, Platformer** package from **Team Cherry** — treat the long store blurb as marketing, but the **genre mix** and **Metacritic 90点台** signal are the real buying compass.
...
- You want **Action, Adventure, Platformer** pacing and the **Metacritic 90点台** band matches your expectations
