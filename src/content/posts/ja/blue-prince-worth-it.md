...
communityMemes:
  ...
  - region hopper
  - MSRP sticker shock
tldr: Blue Prince — Metacritic 92点台；价格信号偏买入（口味要对）。
priceRows:
  - regionCode: BR
    eurPrice: 9.85
    nativePrice: R$88.99
...
**Blue Prince** reads as **Metacritic 92点台**  — **Adventure, Puzzle** beats match what the eShop card promises. **session-friendly runtime** frames how much game you are buying.

**セール**履歴：**最安値**は **€29.99** 付近（IT）、直近1年で **0** 回の動き、**平均セール価格**は **—**、直近の大きめの動きから **—** 日（**2026-04-06 (IT)**）。[GameGulfの価格](https://www.gamegulf.com/detail/FkvknXTNbY#currency-price)で最新行を確認してください。
...
**Blue Prince** is a **Adventure, Puzzle** package from **Dogubomb** — treat the long store blurb as marketing, but the **genre mix** and **Metacritic 92点台** signal are the real buying compass.
...
- You want **Adventure, Puzzle** pacing and the **Metacritic 92点台** band matches your expectations
