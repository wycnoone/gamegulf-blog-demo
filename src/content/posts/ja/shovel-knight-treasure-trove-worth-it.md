...
category: worth-it
gameTitle: "ショベルナイト: Treasure Trove"
...
takeaway: >-
  ショベルナイト: Treasure Troveはアクション / アドベンチャー / プラットフォーム — Nintendo
  Switch版ショベルナイト:を求める人向けです。表の上位地域が目安を見て、今買うか待つか決めましょう。
...
playerNeeds:
  ...
  - buy_now
tags:
  - "ショベルナイト: treasure trove nintendo switch"
  - "ショベルナイト: treasure trove 買うべきか"
  - "ショベルナイト: treasure trove 価格"
  - gamegulf セール
playerVoices:
  - quote: 携帯モードでも十分遊べる。
    sentiment: positive
  ...
  - quote: 自分の地域価格を先に見る。
    sentiment: positive
communityMemes:
  - "ショベルナイト: Treasure Trove セール待ち"
  - 更新確認勢
  - 携帯モード検証
  - 積みゲー候補
  - 地域価格チェック
  - 定価ショック
tldr: "ショベルナイト: Treasure Trove — Metacritic 91点台。価格面は購入寄り。ただし好みが合う場合だけ。"
priceRows:
  - regionCode: JP
    eurPrice: 11.67
    nativePrice: ¥2,160
