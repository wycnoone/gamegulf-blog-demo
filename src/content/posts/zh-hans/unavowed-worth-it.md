---
title: 2026 年还值得在 Switch 上买《Unavowed》吗？
...
takeaway: Unavowed 更像“价格优先”的决策：用 GameGulf 参考价判断紧迫性。
...
communityMemes:
  ...
  - region hopper
  - MSRP sticker shock
tldr: Unavowed — Metacritic 约 91 分；看个人口味与价格是否同时成立。
priceRows:
  - regionCode: BR
    eurPrice: 4.69
    nativePrice: R$27.99
...
**Unavowed** reads as **Metacritic 约 91 分**  — **Adventure, Puzzle, Role-playing** beats match what the eShop card promises. **session-friendly runtime** frames how much game you are buying.

结合 **折扣** 追踪：**历史低价**约 **€4.69**（BR），过去一年约 **1** 次促销，**平均促销价**约 **€4.69**，距上次明显波动约 **29** 天（**2026-03-24 (Brazil, €4.69)**，**2026**）。下单前请再核对 [GameGulf 实时价格](https://www.gamegulf.com/detail/kxyrmTE8vZE#currency-price)。
...
**Unavowed** is a **Adventure, Puzzle, Role-playing** package from **Wadjet Eye Games** — treat the long store blurb as marketing, but the **genre mix** and **Metacritic 约 91 分** signal are the real buying compass.
...
- You want **Adventure, Puzzle, Role-playing** pacing and the **Metacritic 约 91 分** band matches your expectations
...
## 《Unavowed》在 Nintendo Switch — 收尾建议
