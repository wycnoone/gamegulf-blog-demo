...
tags:
  - no mans sky switch
  - no mans sky vaut le coup
  - no mans sky prix switch
  - sandbox spatial switch
  - hello games switch
playerVoices:
  - quote: Quand une planète tombe juste, tu perds ta soirée
    sentiment: positive
  - quote: Le volume post-mises à jour change vraiment la lecture du jeu
    sentiment: positive
  - quote: L'inventaire reste le vrai boss
    sentiment: mixed
  - quote: Poser une base en portable est toujours trop satisfaisant
    sentiment: positive
  - quote: Trop libre pour ceux qui veulent un objectif toutes les deux minutes
    sentiment: negative
  - quote: Le "juste un saut de plus" est toujours réel
    sentiment: positive
communityMemes:
  - encore un warp
  - Tetris d'inventaire
