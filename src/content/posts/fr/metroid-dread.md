...
whatItIs: "Action-aventure 2D : explorez la planète ZDR, débloquez des capacités, échappez aux chasseurs EMMI et affrontez des boss au combat précis."
bestFor: "Joueurs qui aiment le combat réactif, le gating par capacités et les séquences de poursuite sous haute pression."
avoidIf: "Passez si vous n'aimez pas les boss difficiles, les boucles d'échec ou la tension proche de l'horreur."
consensusPraise: "Des contrôles réactifs, des animations impeccables et la menace EMMI qui procure une vraie terreur."
mainFriction: "Les pics de difficulté et les zones EMMI frustrent les joueurs qui veulent une aventure détendue."
