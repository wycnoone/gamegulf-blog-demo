...
tags:
  - atari 50 switch
  - compilation retro switch
  - chronologie interactive jeu
playerVoices:
  - quote: Les timelines transforment une liste ROM en docu jouable cohérente.
    sentiment: positive
  - quote: Lynx/Jaguar sans chasse au hardware — énorme différence.
    sentiment: positive
  - quote: Tu touches tout mais tu ne maîtrises pas tout — cadence à arbitrer.
    sentiment: mixed
  - quote: Les interviews répondent aux questions que les fiches wiki éludent.
    sentiment: positive
...
**Anthologie musée : timelines interactives, interviews et jeux jouables de l’arcade au Jaguar.**

Repères nommés : **Tempest 2000**, **Asteroids**, **Yars' Revenge**, plus Lynx/Jaguar rarement aussi propres sur console moderne ; **Airworld** prolonge l’esprit Swordquest pour une progression guidée hors menus « liste ROM ».

## Comment ça tourne sur Switch ?

Sessions **sofa ou portable** pour alterner clips et boucles arcade courtes — pas un showcase technique.

- **Perf :** jeux 2D légers ; timelines priorisent docu-stream plutôt que shaders lourds — retours joueurs stables sur Switch.
- **Lecture :** navigation pad-first ; casque conseillé pour les interviews tardives.
- **Portée :** solo hors ligne — pas de live-service.

## Acheter / attendre

- **Attends** si ton étiquette UE est à **39,99 €** alors que les **promos** suivies tournent vers **~16,74 €** — surveille **[GameGulf](https://www.gamegulf.com/detail/31CqSWiuTPi#currency-price)** sauf soirée musée imminente.
