...
export const ui = {
  ...
  'home.intent.multiPlatform': {
    en: 'Compare platforms',
    'zh-hans': '多平台比价',
    fr: 'Comparer les plateformes',
    es: 'Comparar plataformas',
    de: 'Plattformen vergleichen',
    ja: 'プラットフォーム比較',
    pt: 'Comparar plataformas',
  },
  'home.intent.multiPlatformDesc': {
    en: 'When a game has multiple versions, check which platform makes the better buy.',
    'zh-hans': '同一游戏有多个版本时，先看哪个平台更适合。',
    fr: 'Quand un jeu existe en plusieurs versions, vérifiez quelle plateforme vaut le plus l\'achat.',
    es: 'Si un juego tiene varias versiones, mira qué plataforma conviene más comprar.',
    de: 'Wenn es mehrere Versionen gibt, prüfe zuerst, welche Plattform der bessere Kauf ist.',
    ja: '複数バージョンがあるゲームは、どの機種で買うべきか先に確認。',
    pt: 'Quando há várias versões, veja primeiro em qual plataforma a compra faz mais sentido.',
  },
  ...
  // Home Hub - Section Copy (Multi-platform mode)
  'home.section.multiPlatform.featured': {
    en: 'Platform comparison picks',
    'zh-hans': '多平台精选',
    fr: 'Sélection multi-plateforme',
    es: 'Selección multiplataforma',
    de: 'Plattform-Vergleiche',
    ja: '機種別比較の注目作',
    pt: 'Destaques multiplataforma',
  },
  'home.section.multiPlatform.featuredDesc': {
    en: 'Start with guides where version, upgrade, or platform pricing differences matter.',
    'zh-hans': '优先看有版本差异、升级包或跨平台价格差的指南。',
    fr: 'Commencez par les guides où versions, mises à niveau ou écarts de prix comptent vraiment.',
    es: 'Empieza por guías donde importan las versiones, mejoras o diferencias de precio por plataforma.',
    de: 'Guides, bei denen Versionen, Upgrades oder Plattformpreise wirklich zählen.',
    ja: 'バージョン差、アップグレード、機種別価格差が判断材料になるガイド。',
    pt: 'Comece por guias em que versão, upgrade ou preço por plataforma mudam a decisão.',
  },
  'home.section.multiPlatform.latest': {
    en: 'More platform comparison guides',
    'zh-hans': '更多多平台指南',
    fr: 'Plus de guides multi-plateforme',
    es: 'Más guías multiplataforma',
    de: 'Weitere Plattform-Vergleiche',
    ja: '機種別比較ガイドをもっと見る',
    pt: 'Mais guias multiplataforma',
  },
